...
#include "moveit_wrapper_interfaces/srv/detail/plan__rosidl_typesupport_fastrtps_c.h"
...
using _Plan_Request__ros_msg_type = moveit_wrapper_interfaces__srv__Plan_Request;
...
size_t get_serialized_size_moveit_wrapper_interfaces__srv__Plan_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Plan_Request__ros_msg_type * ros_message = static_cast<const _Plan_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Plan_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_moveit_wrapper_interfaces__srv__Plan_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_wrapper_interfaces
size_t max_serialized_size_moveit_wrapper_interfaces__srv__Plan_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = moveit_wrapper_interfaces__srv__Plan_Request;
    is_plain =
      (
...
static size_t _Plan_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_moveit_wrapper_interfaces__srv__Plan_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, moveit_wrapper_interfaces, srv, Plan_Request)() {
...
using _Plan_Response__ros_msg_type = moveit_wrapper_interfaces__srv__Plan_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_wrapper_interfaces
size_t get_serialized_size_moveit_wrapper_interfaces__srv__Plan_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Plan_Response__ros_msg_type * ros_message = static_cast<const _Plan_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_moveit_wrapper_interfaces__srv__Plan_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_wrapper_interfaces
size_t max_serialized_size_moveit_wrapper_interfaces__srv__Plan_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = moveit_wrapper_interfaces__srv__Plan_Response;
    is_plain =
      (
...
static size_t _Plan_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_moveit_wrapper_interfaces__srv__Plan_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, moveit_wrapper_interfaces, srv, Plan_Response)() {
...
// already included above
// #include "moveit_wrapper_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "moveit_wrapper_interfaces/srv/plan.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, moveit_wrapper_interfaces, srv, Plan)() {
  return &Plan__handle;
}
