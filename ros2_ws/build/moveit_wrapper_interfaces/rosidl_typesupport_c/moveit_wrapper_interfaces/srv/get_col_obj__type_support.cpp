...
static const _GetColObj_Request_type_support_symbol_names_t _GetColObj_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, moveit_wrapper_interfaces, srv, GetColObj_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_wrapper_interfaces, srv, GetColObj_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, moveit_wrapper_interfaces, srv, GetColObj_Request)() {
  return &::moveit_wrapper_interfaces::srv::rosidl_typesupport_c::GetColObj_Request_message_type_support_handle;
}
...
static const _GetColObj_Response_type_support_symbol_names_t _GetColObj_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, moveit_wrapper_interfaces, srv, GetColObj_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_wrapper_interfaces, srv, GetColObj_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, moveit_wrapper_interfaces, srv, GetColObj_Response)() {
  return &::moveit_wrapper_interfaces::srv::rosidl_typesupport_c::GetColObj_Response_message_type_support_handle;
}
...
static const _GetColObj_type_support_symbol_names_t _GetColObj_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, moveit_wrapper_interfaces, srv, GetColObj)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_wrapper_interfaces, srv, GetColObj)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, moveit_wrapper_interfaces, srv, GetColObj)() {
  return &::moveit_wrapper_interfaces::srv::rosidl_typesupport_c::GetColObj_service_type_support_handle;
}
