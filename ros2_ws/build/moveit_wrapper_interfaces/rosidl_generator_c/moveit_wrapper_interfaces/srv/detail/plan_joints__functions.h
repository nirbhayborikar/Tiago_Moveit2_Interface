...
#ifndef MOVEIT_WRAPPER_INTERFACES__SRV__DETAIL__PLAN_JOINTS__FUNCTIONS_H_
#define MOVEIT_WRAPPER_INTERFACES__SRV__DETAIL__PLAN_JOINTS__FUNCTIONS_H_
...
/// Initialize srv/PlanJoints message.
/**
...
/// Finalize srv/PlanJoints message.
/**
...
/// Create srv/PlanJoints message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * moveit_wrapper_interfaces__srv__PlanJoints_Request__init().
...
/// Destroy srv/PlanJoints message.
/**
 * It calls
 * moveit_wrapper_interfaces__srv__PlanJoints_Request__fini()
...
/// Check for srv/PlanJoints message equality.
/**
...
/// Initialize array of srv/PlanJoints messages.
/**
...
/// Finalize array of srv/PlanJoints messages.
/**
 * It calls
 * moveit_wrapper_interfaces__srv__PlanJoints_Request__fini()
...
/// Create array of srv/PlanJoints messages.
/**
 * It allocates the memory for the array and calls
 * moveit_wrapper_interfaces__srv__PlanJoints_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/PlanJoints messages.
/**
 * It calls
 * moveit_wrapper_interfaces__srv__PlanJoints_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/PlanJoints message array equality.
/**
...
/// Copy an array of srv/PlanJoints messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * moveit_wrapper_interfaces__srv__PlanJoints_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_moveit_wrapper_interfaces
...
/**
 * It calls
 * moveit_wrapper_interfaces__srv__PlanJoints_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_moveit_wrapper_interfaces
...
/**
 * It allocates the memory for the array and calls
 * moveit_wrapper_interfaces__srv__PlanJoints_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_moveit_wrapper_interfaces
...
/**
 * It calls
 * moveit_wrapper_interfaces__srv__PlanJoints_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MOVEIT_WRAPPER_INTERFACES__SRV__DETAIL__PLAN_JOINTS__FUNCTIONS_H_
