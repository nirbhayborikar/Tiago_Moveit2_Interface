...
bool moveit_wrapper_interfaces__msg__waypoint_sequence__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_wrapper_interfaces.msg._waypoint_sequence.WaypointSequence", full_classname_dest, 65) == 0);
  }
  moveit_wrapper_interfaces__msg__WaypointSequence * ros_message = _ros_message;
  {  // sequence_id
    ...
    rosidl_runtime_c__String__assign(&ros_message->sequence_id, PyBytes_AS_STRING(encoded_field));
  ...
  {  // use_linear_interpolation
    PyObject * field = PyObject_GetAttrString(_pymsg, "use_linear_interpolation");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->use_linear_interpolation = (Py_True == field);
    Py_DECREF(field);
  }
  {  // velocity_scaling
...
PyObject * moveit_wrapper_interfaces__msg__waypoint_sequence__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("moveit_wrapper_interfaces.msg._waypoint_sequence");
  ...
  {  // sequence_id
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->sequence_id.data,
      strlen(ros_message->sequence_id.data),
      "replace");
    if (!field) {
      return NULL;
    }
  ...
  {  // use_linear_interpolation
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->use_linear_interpolation ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "use_linear_interpolation", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
