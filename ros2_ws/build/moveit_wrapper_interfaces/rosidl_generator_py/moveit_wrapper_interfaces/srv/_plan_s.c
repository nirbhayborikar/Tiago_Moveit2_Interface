...
bool moveit_wrapper_interfaces__msg__waypoint__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool moveit_wrapper_interfaces__srv__plan__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_wrapper_interfaces.srv._plan.Plan_Request", full_classname_dest, 48) == 0);
  }
  moveit_wrapper_interfaces__srv__Plan_Request * ros_message = _ros_message;
  {  // waypoints
    ...
    if (!moveit_wrapper_interfaces__msg__Waypoint__Sequence__init(&(ros_message->waypoints), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create moveit_wrapper_interfaces__msg__Waypoint__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    moveit_wrapper_interfaces__msg__Waypoint * dest = ros_message->waypoints.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!moveit_wrapper_interfaces__msg__waypoint__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // send_partial
    PyObject * field = PyObject_GetAttrString(_pymsg, "send_partial");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->send_partial = (Py_True == field);
    Py_DECREF(field);
  }
  {  // use_start_state
    PyObject * field = PyObject_GetAttrString(_pymsg, "use_start_state");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->use_start_state = (Py_True == field);
    Py_DECREF(field);
  }
  {  // start_state
...
PyObject * moveit_wrapper_interfaces__srv__plan__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("moveit_wrapper_interfaces.srv._plan");
  ...
  {  // waypoints
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = moveit_wrapper_interfaces__msg__waypoint__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // send_partial
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->send_partial ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "send_partial", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // use_start_state
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->use_start_state ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "use_start_state", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
...
ROSIDL_GENERATOR_C_EXPORT
bool moveit_wrapper_interfaces__srv__plan__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_wrapper_interfaces.srv._plan.Plan_Response", full_classname_dest, 49) == 0);
  }
  moveit_wrapper_interfaces__srv__Plan_Response * ros_message = _ros_message;
  {  // success
