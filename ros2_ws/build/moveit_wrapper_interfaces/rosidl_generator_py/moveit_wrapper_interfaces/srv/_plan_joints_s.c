...
bool moveit_wrapper_interfaces__srv__plan_joints__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_wrapper_interfaces.srv._plan_joints.PlanJoints_Request", full_classname_dest, 61) == 0);
  }
  moveit_wrapper_interfaces__srv__PlanJoints_Request * ros_message = _ros_message;
  {  // joint_states
...
{
  /* NOTE(esteve): Call constructor of PlanJoints_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("moveit_wrapper_interfaces.srv._plan_joints");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PlanJoints_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool moveit_wrapper_interfaces__srv__plan_joints__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("moveit_wrapper_interfaces.srv._plan_joints.PlanJoints_Response", full_classname_dest, 62) == 0);
  }
  moveit_wrapper_interfaces__srv__PlanJoints_Response * ros_message = _ros_message;
  {  // success
...
{
  /* NOTE(esteve): Call constructor of PlanJoints_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("moveit_wrapper_interfaces.srv._plan_joints");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PlanJoints_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
