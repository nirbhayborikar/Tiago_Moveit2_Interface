...
#include "moveit_wrapper_interfaces/srv/detail/plan_joints__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const moveit_wrapper_interfaces::srv::PlanJoints_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  moveit_wrapper_interfaces::srv::PlanJoints_Request & ros_message)
{
  // Member: joint_states
  {
    uint32_t cdrSize;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_moveit_wrapper_interfaces
max_serialized_size_PlanJoints_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = moveit_wrapper_interfaces::srv::PlanJoints_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const moveit_wrapper_interfaces::srv::PlanJoints_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<moveit_wrapper_interfaces::srv::PlanJoints_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PlanJoints_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const moveit_wrapper_interfaces::srv::PlanJoints_Request *>(
...
static size_t _PlanJoints_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PlanJoints_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PlanJoints_Request__callbacks = {
...
static rosidl_message_type_support_t _PlanJoints_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PlanJoints_Request__callbacks,
...
{
  return &moveit_wrapper_interfaces::srv::typesupport_fastrtps_cpp::_PlanJoints_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moveit_wrapper_interfaces, srv, PlanJoints_Request)() {
  return &moveit_wrapper_interfaces::srv::typesupport_fastrtps_cpp::_PlanJoints_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_moveit_wrapper_interfaces
cdr_serialize(
  const moveit_wrapper_interfaces::srv::PlanJoints_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  moveit_wrapper_interfaces::srv::PlanJoints_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_moveit_wrapper_interfaces
max_serialized_size_PlanJoints_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = moveit_wrapper_interfaces::srv::PlanJoints_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const moveit_wrapper_interfaces::srv::PlanJoints_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<moveit_wrapper_interfaces::srv::PlanJoints_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PlanJoints_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const moveit_wrapper_interfaces::srv::PlanJoints_Response *>(
...
static size_t _PlanJoints_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PlanJoints_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PlanJoints_Response__callbacks = {
  "moveit_wrapper_interfaces::srv",
  "PlanJoints_Response",
...
static rosidl_message_type_support_t _PlanJoints_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PlanJoints_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &moveit_wrapper_interfaces::srv::typesupport_fastrtps_cpp::_PlanJoints_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moveit_wrapper_interfaces, srv, PlanJoints_Response)() {
  return &moveit_wrapper_interfaces::srv::typesupport_fastrtps_cpp::_PlanJoints_Response__handle;
}
...
static service_type_support_callbacks_t _PlanJoints__callbacks = {
  "moveit_wrapper_interfaces::srv",
  "PlanJoints",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moveit_wrapper_interfaces, srv, PlanJoints_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moveit_wrapper_interfaces, srv, PlanJoints_Response)(),
...
static rosidl_service_type_support_t _PlanJoints__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PlanJoints__callbacks,
...
{
  return &moveit_wrapper_interfaces::srv::typesupport_fastrtps_cpp::_PlanJoints__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moveit_wrapper_interfaces, srv, PlanJoints)() {
  return &moveit_wrapper_interfaces::srv::typesupport_fastrtps_cpp::_PlanJoints__handle;
}
