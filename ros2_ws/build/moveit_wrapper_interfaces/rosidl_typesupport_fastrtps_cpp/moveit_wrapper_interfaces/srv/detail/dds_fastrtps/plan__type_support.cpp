...
#include "moveit_wrapper_interfaces/srv/detail/plan__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const moveit_wrapper_interfaces::srv::Plan_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  moveit_wrapper_interfaces::srv::Plan_Request & ros_message)
{
  // Member: waypoints
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = moveit_wrapper_interfaces::srv::Plan_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const moveit_wrapper_interfaces::srv::Plan_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<moveit_wrapper_interfaces::srv::Plan_Request *>(
    untyped_ros_message);
...
{
  return &moveit_wrapper_interfaces::srv::typesupport_fastrtps_cpp::_Plan_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moveit_wrapper_interfaces, srv, Plan_Request)() {
  return &moveit_wrapper_interfaces::srv::typesupport_fastrtps_cpp::_Plan_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_moveit_wrapper_interfaces
cdr_serialize(
  const moveit_wrapper_interfaces::srv::Plan_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  moveit_wrapper_interfaces::srv::Plan_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = moveit_wrapper_interfaces::srv::Plan_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const moveit_wrapper_interfaces::srv::Plan_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<moveit_wrapper_interfaces::srv::Plan_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &moveit_wrapper_interfaces::srv::typesupport_fastrtps_cpp::_Plan_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moveit_wrapper_interfaces, srv, Plan_Response)() {
  return &moveit_wrapper_interfaces::srv::typesupport_fastrtps_cpp::_Plan_Response__handle;
}
...
{
  return &moveit_wrapper_interfaces::srv::typesupport_fastrtps_cpp::_Plan__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moveit_wrapper_interfaces, srv, Plan)() {
  return &moveit_wrapper_interfaces::srv::typesupport_fastrtps_cpp::_Plan__handle;
}
